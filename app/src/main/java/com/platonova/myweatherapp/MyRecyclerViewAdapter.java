...
import com.platonova.myweatherapp.Data.Weather;
...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter<MyRecyclerViewAdapter.ViewHolder> {
    ...
    MyRecyclerViewAdapter(Context applicationContext, java.util.List<List> data) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        String temp =""+(int) ((mData.get(position).getMain().getTemp()) - 273);
